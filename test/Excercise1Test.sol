...
contract ERC20Test is Test {
    ...
    function setUp() public {
        ...
        token = new ERC20("Test Token", "TEST", 18, 1000000e18);
    ...
    function testInitialState() public {
        ...
        assertEq(token.balanceOf(owner), 990000e18);
    }
    ...
    function testTransfer() public {
        ...
        assertEq(token.balanceOf(owner), 990000e18 - amount);
    }

    function testTransferFailsInsufficientBalance() public {
        uint256 amount = 1000001e18; // More than total supply
